...
This tree had **zero** shell scripts. So `mange` is currently a contract
...
## Tooling in other languages, not reachable through the verb (10 files)
...
- `public/app.js`
- `public/receipt-parse.js`
- `public/sw.js`
- `scripts/gen-icons.js`
- `src/server.js`
- `src/store.js`
- `tests/api.test.js`
- `tests/receipt-parse.test.js`
- `tests/store.test.js`
- `tests/visual-smoke.js`

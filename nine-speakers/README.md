...
This is the **bashified** branch of `nine-speakers`. It contains a plain shell
utility and nothing else.

```
bin/chante          the utility
man/chante.1        how to use it
...
```
./test/contract-test.sh bin/chante
```

...
*probe what this system cannot see, and measure it*

This is the **bashified** branch of `ecosim`. It contains a plain shell
utility and nothing else.

```
bin/sonde          the utility
man/sonde.1        how to use it
...
```
./test/contract-test.sh bin/sonde
```

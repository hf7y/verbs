...
*train the hands: vim motions as a game mechanic*

This is the **bashified** branch of `vim-arcade`. It contains a plain shell
utility and nothing else.

```
bin/entraine          the utility
man/entraine.1        how to use it
